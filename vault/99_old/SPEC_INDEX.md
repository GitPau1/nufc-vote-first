...
|------|------------|--------------------------|
| [01-architecture.md](01-architecture.md) | 폴더 구조, Supabase 연동, 환경변수 | — |
...
| [11-design-system.md](11-design-system.md) | 색상·타이포·radius·shadow 토큰, 컴포넌트 패턴, Tailwind 설정 | — |
...
- 투표는 **제출 후 수정 불가** — DB UNIQUE 제약으로 중복 투표 차단. **승부예측은 예외로 킥오프 전까지 수정 가능**(2026-09-03 확정, 근거: `vault/10_gun/승부예측-랭킹-요구사항-명세서.md` NFR-001)
