...
// 실제 photoUrl은 lib/predictions/candidates.ts의 playerPhotoUrl(fotmobPlayerId)이 Supabase
// Storage public 주소(.../player-photos/players/{id}.png)로 조립한다. 버킷에 파일이 있는 스쿼드
// 선수여야 200이고 없는 id는 400이라, 다른 예측 mock과 같은 placehold.co를 쓴다.
...
const BROKEN_PHOTO = 'https://storage.invalid/storage/v1/object/public/player-photos/players/999999.png'
...
/**
 * **URL은 있는데 로드가 실패하는 경우** — 버킷에 파일이 없는 신입·유스라 Storage가 400을 주는 상황이다.
