...
export const Shell: Story = {
  render: () => (
    <section className="w-96 space-y-2.5 rounded-lg border border-border bg-surface p-4 shadow-g200">
  ...
  render: () => (
    <section className="w-96 space-y-2.5 rounded-lg border border-border bg-surface p-4 shadow-g200">
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          className="inline-flex h-8 items-center gap-1.5 rounded-sm bg-disabled px-2.5 text-caption-1 font-bold text-foreground"
        >
    ...
    <section className="w-96 space-y-2.5 rounded-lg border border-border bg-surface p-4 shadow-g200">
      ...
      <div className="flex items-center gap-3 rounded-md border border-border bg-disabled px-3 py-2">
        ...
        <div className="min-w-0">
          <p className="truncate text-label-2 font-black text-foreground">손흥민</p>
        </div>
      </div>
    </section>
  ),
