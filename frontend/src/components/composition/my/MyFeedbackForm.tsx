  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      <textarea
        ...
        className="min-h-[180px] w-full resize-none rounded-sm border border-neutral-weak bg-surface px-4 py-3 text-body-1-reading text-neutral outline-none placeholder:text-placeholder focus:border-brand-solid"
