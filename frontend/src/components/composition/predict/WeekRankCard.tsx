        ...
        <>
          ...
          {!expanded && overLimit && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center rounded-md border border-neutral-weak p-2.5 text-label-2 font-medium text-neutral-muted transition-colors duration-micro hover:border-neutral-strong"
            >
